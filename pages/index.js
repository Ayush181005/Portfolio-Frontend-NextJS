      ...
      <main className={`${styles.main} ${inter.className}`}>
        ...
        <section className={styles.aboutSection}>
          ...
          <div className={styles.short} id="short" style={{display: "none"}}>
            <p>
              My story is a reflection of a simple yet powerful motto: choosing what brings immediate happiness has always led me in the right direction ✨. This hunger for fun and learning turned a curious school kid—who studied extra chapters just for the thrill of it—into a multidisciplinary engineer 📚👨‍🔧. A massive part of this evolution was my early obsession with programming, starting from scribbling code in notebooks in 7th grade to mastering languages that now power my engineering simulations 💻📝. What began as a 14-hour-a-day addiction eventually matured into a vital skill, allowing me to bridge the gap between abstract theory and innovative solutions 🌉💡.
            </p>
            <p>
              That same drive pushed me into the depths of research at PDEU and IIT Gandhinagar, where I’ve tackled everything from additive manufacturing and bio-implants to leading rocketry teams like Apogee3 and Zenith 🚀🔬. Winning excellence awards for my work on avalanche modeling and publishing papers has only deepened my resolve to create solutions that impact the real world 🏆❄️. From overcoming my fear of Karate to win a state-level bronze to navigating complex engineering challenges, my journey is a testament to <span className={styles.highlight}>tenacity</span> and <span className={styles.highlight}>confidence</span>, proving that a life led by curiosity is the most rewarding adventure of all 🥋🌏.
            </p>
          ...
          <div id="detail" className={styles.detail}>
            <p>
              ...
              What I am is reflection of my journey till now, so here I have my 20+ years in a few words.<br />The only motto in my story, especially when making choices, is to pick what makes me <span className={styles.highlight}>happy</span> right now instead of worrying about other things. Somehow, that path has always proven to be exactly the right direction for me. Fun and enjoyment drive the plot, though luck has been a key factor since my childhood. I was lucky to find open doors, but I had the hunger to learn and grab every single opportunity that appeared. As a curious adventurer, I have grown my skills across the entire landscape of STEAM. I usually describe myself as a simple combination of <span className={styles.highlight}>science, art, tennis, and happiness</span>.
            </p>
            <p>
